      ...
      <div className="max-w-md w-full mx-4 relative z-10">
        <div className="glass rounded-3xl shadow-2xl p-8 md:p-12 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Momez Shoes'a katılın</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white rounded-full"
            >
